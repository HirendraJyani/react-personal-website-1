        ...
        <div id="mycontacts" className="contact">
            ...
            <div className="contact_info" data-aos={"zoom-in"}>
                ...
                <p>If you have a project that you want to get started, 
                    think you need my help with something or just fancy saying hey, then get in touch.</p><br/>
                ...
                <div className="contact_details">
                    ...
                    <div className="contact_details_info">
                        <h3>Email</h3>
                        <p><a className="project_links" href="mailto:itshirendra@gmail.com" > itshirendra@gmail.com </a></p>
                    </div>
                </div><br/>
                <div className="contact_details">
                    ...
                    <div className="contact_details_info">
                        <h3>Instagram</h3>
                        <p><a className="project_links" href="https://www.instagram.com/its_hirendra/" rel="noreferrer" target="_blank"> its_hirendra </a></p>
